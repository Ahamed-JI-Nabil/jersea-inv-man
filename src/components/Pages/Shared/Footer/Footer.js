...
import jersea from '../../../../images/Main LOGO ONG.png'

const Footer = () => {
    return (
        <footer class="footer footer-center p-10 bg-slate-900 text-primary-content">
            <div>
                <img className='w-28' src={jersea} alt="jersea" />
                <p class="font-bold">
